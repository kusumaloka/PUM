		...
		<div class="page">
			<div class="page-region">
				<div class="page-region-content">
					...
					<p class="description">
					Silahkan edit jadwal mata kuliah yang ada
					</p>
					<form action="update.php" method="POST">
						...
						<div class="input-control text" data-role="input-control">
							<?php
								...
								$sql="SELECT * FROM t_dosen, t_dosen_anggota, t_matakuliah, t_ruang, t_semester, t_tahunajar, t_jadwal 
									WHERE 
										t_jadwal.kd_jadwal=('$kd_jadwal') and
										...
										echo "<input name='kd_jadwal' type='text' placeholder='type text' value=$kd_jadwal>";
							?>
						</div>
							...
							<?php
								...
								$sql="SELECT * FROM t_dosen, t_dosen_anggota, t_matakuliah, t_ruang, t_semester, t_tahunajar, t_jadwal 
									WHERE 
										...
										$hasil_query=mysql_query($sql);
										while($baris=mysql_fetch_object($hasil_query))	
										echo "<option selected value=$baris->kd_semester>$baris->kd_semester </option>";
							?>
							<?php
							...
							<select name="kd_tahunajar">
								...
								$sql="SELECT * FROM t_dosen, t_dosen_anggota, t_matakuliah, t_ruang, t_semester, t_tahunajar, t_jadwal 
									WHERE 
										...
										$hasil_query=mysql_query($sql);
										while($baris=mysql_fetch_object($hasil_query))	
										echo "<option selected value=$baris->kd_tahunajar>$baris->kd_tahunajar </option>";
								?>
								<?php
									include_once "./function/koneksi.php";
									koneksi_mysql();
							...
							<select name="kd_matakuliah">
								...
								$sql="SELECT * FROM t_dosen, t_dosen_anggota, t_matakuliah, t_ruang, t_semester, t_tahunajar, t_jadwal 
									WHERE 
										...
										$hasil_query=mysql_query($sql);
										while($baris=mysql_fetch_object($hasil_query))	
										echo "<option selected value=$baris->kd_matakuliah>$baris->nama_matakuliah ($baris->jenis)</option>";
								?>
								<?php
									include_once "./function/koneksi.php";
									koneksi_mysql();
									...
									$sql="SELECT * FROM t_matakuliah 
										WHERE 
											t_matakuliah.semester=('5')";
											$hasil_query=mysql_query($sql);
											while($baris=mysql_fetch_object($hasil_query))	
											echo "<option value=$baris->kd_matakuliah>$baris->nama_matakuliah ($baris->jenis)</option>";
								?>
							</select>
						</div>
							...
							<select name="kd_dosen">
								...
								$sql="SELECT * FROM t_dosen, t_dosen_anggota, t_matakuliah, t_ruang, t_semester, t_tahunajar, t_jadwal 
									WHERE 
										...
										$hasil_query=mysql_query($sql);
										while($baris=mysql_fetch_object($hasil_query))	
										echo "<option selected value=$baris->kd_dosen>$baris->gelar_depan $baris->nama, $baris->gelar_belakang</option>";
								?>
								<?php
									include_once "./function/koneksi.php";
									koneksi_mysql();
							...
							<select name="kd_dosen_anggota">
								...
								$sql="SELECT * FROM t_dosen, t_dosen_anggota, t_matakuliah, t_ruang, t_semester, t_tahunajar, t_jadwal 
									WHERE 
										...
										$hasil_query=mysql_query($sql);
										while($baris=mysql_fetch_object($hasil_query))	
										echo "<option selected value=$baris->kd_dosenanggota>$baris->gelar_depan_anggota $baris->nama_dosen_anggota, $baris->gelar_belakang_anggota</option>";
								?>
								<?php
									include_once "./function/koneksi.php";
									koneksi_mysql();
							...
							<select name="jam_mulai">
								...
								$sql="SELECT * FROM t_dosen, t_dosen_anggota, t_matakuliah, t_ruang, t_semester, t_tahunajar, t_jadwal 
									WHERE 
										...
										echo "<option selected value=$jam_mulai>$jam_mulai</option>";
								?>
							...
							<select name="menit_mulai">
								...
								$sql="SELECT * FROM t_dosen, t_dosen_anggota, t_matakuliah, t_ruang, t_semester, t_tahunajar, t_jadwal 
									WHERE 
										...
										echo "<option selected value=$menit_mulai>$menit_mulai</option>";
								?>
							...
							<select name="jam_selesai">
								...
								$sql="SELECT * FROM t_dosen, t_dosen_anggota, t_matakuliah, t_ruang, t_semester, t_tahunajar, t_jadwal 
									WHERE 
										...
										echo "<option selected value=$jam_selesai>$jam_selesai</option>";
								?>
								<option value="07">07</option>
								<option value="08">08</option>
								<option value="09">09</option>
							...
							<select name="menit_selesai">
								...
								$sql="SELECT * FROM t_dosen, t_dosen_anggota, t_matakuliah, t_ruang, t_semester, t_tahunajar, t_jadwal 
									WHERE 
										...
										echo "<option selected value=$menit_selesai>$menit_selesai</option>";
								?>
								<option value="00">00</option>
								<option value="01">01</option>
								<option value="02">02</option>
							...
							<select name="kd_ruang">
								...
								$sql="SELECT * FROM t_dosen, t_dosen_anggota, t_matakuliah, t_ruang, t_semester, t_tahunajar, t_jadwal 
									WHERE 
										...
										$hasil_query=mysql_query($sql);
										while($baris=mysql_fetch_object($hasil_query))	
										echo "<option selected value=$baris->kd_ruang>$baris->nama_ruang</option>";
								?>
								<?php
									include_once "./function/koneksi.php";
									koneksi_mysql();
						...
						<div class="input-control select" data-role="input-control">
							<select name="kd_hari">
								...
								koneksi_mysql();
								$kd_jadwal=$_GET['kd_jadwal'];
								$sql="SELECT * FROM t_dosen, t_dosen_anggota, t_matakuliah, t_ruang, t_semester, t_tahunajar, t_jadwal, t_hari
									WHERE 
										t_jadwal.kd_jadwal=('$kd_jadwal') and
										t_jadwal.kd_dosen1=t_dosen.kd_dosen and 
										t_jadwal.kd_dosenanggota=t_dosen_anggota.kd_dosen_anggota and
										...
										t_jadwal.kd_hari=t_hari.kd_hari";
										$hasil_query=mysql_query($sql);
										while($baris=mysql_fetch_object($hasil_query))	
										echo "<option selected value=$baris->kd_hari>$baris->nama_hari</option>";
								?>
								<?php
									include_once "./function/koneksi.php";
									koneksi_mysql();
