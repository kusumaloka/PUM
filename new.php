...
include_once "./function/koneksi.php";
	...
	INSERT INTO `time_tabling`.`t_jadwal` 
		(`kd_jadwal`, `kd_semester`, `kd_tahunajar`, `kd_matakuliah`, `kd_dosen1`, `kd_dosenanggota`, `jam_mulai`, `jam_selesai`, `kd_ruang`, `kd_hari`)
	VALUES
		('$kd_jadwal', 
		'$kd_semester', 
		'$kd_tahunajar', 
	...
	echo "";	
	echo "";
	echo "		<title>Selamat Anda berhasil menambah jadwal Semester $kd_semester</title>";
	echo "	</head>";
	echo "";
	...
	echo "					<h1>";
	echo "					Selamat Anda telah berhasil menambah jadwal kuliah Semester $kd_semester";
	echo "					</h1>";
	echo "					<br>";
	echo "					<h2>";
